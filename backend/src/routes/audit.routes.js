 ...
 *
 *       For each ballot:
 *       1. Load the votes from ballotvotes table
 *       2. Re-calculate hash using: previousHash|sortedVotes|electionId|BALLOT_SECRET
 *       3. Compare with stored ballot_hash
 *
 *       If ANY hash doesn't match, votes were manipulated.
 *     tags:
 *       - Audit
 *     security:
 *       - cookieAuth: []
