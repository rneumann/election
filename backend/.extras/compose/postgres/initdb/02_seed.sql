...
\echo 'elections'
\copy elections (id, info, description, listvotes, seats_to_fill, votes_per_ballot, max_cumulative_votes, start, "end", election_type, counting_method) FROM '/docker-entrypoint-initdb.d/data/csv/elections.csv' CSV HEADER;
