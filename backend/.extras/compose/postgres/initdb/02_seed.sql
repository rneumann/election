...
\echo 'elections'
\copy elections (id, info, description, listvotes, votes_per_ballot, max_cumulative_votes, start, "end", election_type, counting_method) FROM '/docker-entrypoint-initdb.d/data/csv/elections.csv' CSV HEADER;
